...
//                _viewModel.showToast.value = context?.resources?.getString(R.string.permission_denied_explanation)
            Snackbar.make(
                binding.root,
                "You need to enable location in order to find your location",
